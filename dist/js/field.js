...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-button-link', __webpack_require__(3));
  Vue.component('detail-button-link', __webpack_require__(6));
  Vue.component('form-button-link', __webpack_require__(9));
});
      ...
      _c("template", { slot: "field" }, [
        _c(
          "a",
          {
            ...
            class: [_vm.field.buttonClasses],
            attrs: { href: [_vm.field.path], id: _vm.field.name, type: "text" },
            model: {
              value: _vm.value,
              callback: function($$v) {
                _vm.value = $$v
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
     ...
     */
    fill: function fill(formData, event) {}
  }
});
